...
Arguments le {R} x%_Rval y%_Rval : rename, simpl never.
Arguments sup {R} E%_Rset : rename, simpl never.
Arguments add {R} x%_Rval y%_Rval : rename, simpl never.
Arguments opp {R} x%_Rval : rename, simpl never.
Arguments mul {R} x%_Rval y%_Rval : rename, simpl never.
Arguments inv {R} x%_Rval : rename, simpl never.
Arguments eq {R} x%_Rval y%_Rval.
Arguments ub {R} E%_Rset x%_Rval.
Arguments down {R} E%_Rset x%_Rval.
Arguments nonempty {R} E%_Rset.
Arguments has_ub {R} E%_Rset.
Arguments has_sup {R} E%_Rset.
Arguments image {R S} phi E%_Rset y%_Rval.
Arguments nat R n%_nat: simpl never.
Arguments select_set {R} P%_type x%_Rval y%_Rval _%_Rval.
Arguments select {R} P%_type x%_Rval y%_Rval.
Arguments extended_inv {R} x%_Rval.
Arguments extended_sup {R} E%_Rset.
